...
用法：1、先安装 python x64.exe
2、pip install -r requirements.txt
3、python ProxyCat.py
执行方法
C:\Users\用户名\Desktop\ProxyCat-main\ProxyCat-main>pip install -r requirements.txt
C:\Users\用户名\Desktop\ProxyCat-main\ProxyCat-main>python ProxyCat.py
这个pythn 3.9 是原版的，用别的版本也可以 
## 功能特点
